...
PHP, Javascript, and so on. It is particularly well-suited to data manipulation and statistical analysis, because it was originally designed by statisticians with these things in mind. It has thus become very popular among data analysts
and statisticians.
...
ecosystem of packages and other resources. Most notably for data science is the tidyverse, a group of packages built specifically to make working with data in R quicker and easier. And, there is a strong community of R users, so it's
