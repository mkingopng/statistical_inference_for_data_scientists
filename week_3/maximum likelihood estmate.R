library(ggplot2)
Theta=1.1
# Choose a value for Theta to be estimated
n=300
# Number of samples
x=rexp(n, rate=1/Theta)
# Generating n samples of exponentially distrib
...
sprintf("Theta =%4.2f would maximize the Likelihood function of this expone
